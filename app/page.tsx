...
export default function Home() {
  return (
    <main className="min-h-screen min-h-dvh bg-[#FBF8F2] text-[#141110] font-sans selection:bg-[#1D3F91] selection:text-[#FFFFFF]">
      ...
      {/* 4. OPERATIONAL SIGNALS & BENCHMARKS (High-Impact Royal Deep Band) */}
      <section className="py-16 bg-[#101F45] text-[#FBF8F2] relative overflow-hidden border-b-2 border-[#1D3F91]/40">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-white/10 pb-6 mb-12">
            <Eyebrow variant="on-dark" prefixDot>
              TALENT EXECUTION &amp; RELIABILITY
            </Eyebrow>
            <h2 className="font-serif font-bold text-lg text-[#FBF8F2] mt-2 sm:mt-0">
              Why Trained, Pre-Vetted, and Fast Hiring Matters
            </h2>
            <Eyebrow variant="on-dark" className="mt-2 sm:mt-0">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            <div className="pt-6 sm:pt-0 sm:pl-6 space-y-2">
              <Eyebrow variant="on-dark" as="div">
                CONTINUOUS SOURCING
              </Eyebrow>
              <h3 className="text-xl sm:text-2xl font-serif font-bold tracking-tight text-[#FBF8F2]">
        ...
        <div className="grid gap-8 md:grid-cols-12 mt-12 items-stretch">
          ...
          <div className="border border-[#15120F]/15 bg-[#F0E9D5]/60 rounded-3xl p-8 md:p-10 md:col-span-7 flex flex-col gap-6 sm:gap-8 hover:border-[#15120F]/30 transition-all group">
            <div className="space-y-3">
              <Eyebrow prefixDot>Pipeline Execution</Eyebrow>
          ...
          <div className="border-2 border-[#15120F]/15 bg-[#F0E9D5]/60 rounded-3xl p-8 md:p-10 md:col-span-5 flex flex-col gap-6 hover:border-[#15120F]/30 transition-all">
            <div className="space-y-3">
              <Eyebrow prefixDot>Candidate Evaluation</Eyebrow>
      ...
      <section className="py-24 bg-[#FBF8F2] border-t border-[#15120F]/10">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {BANGALORE_AREAS.map((item) => (
              <div
                key={item.area}
                className="border border-[#15120F]/10 bg-[#F0E9D5]/40 rounded-2xl p-6 flex flex-col justify-between hover:border-[#1D3F91]/40 transition-colors"
              >
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <MapPin className="w-4 h-4 text-[#1D3F91]" />
      ...
      <section id="contact" className="relative py-24 overflow-hidden bg-[#FBF8F2] border-t border-[#15120F]/10">
        <div className="absolute inset-0">
          <div className="absolute left-1/2 top-0 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[#1D3F91]/10 blur-3xl" />
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10 relative z-10">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-stretch max-w-5xl mx-auto">
            {/* Form Card */}
            <div className="bg-[#FBF8F2] border-2 border-[#15120F]/15 rounded-3xl shadow-[4px_4px_0px_0px_rgba(21,18,15,0.06)] overflow-hidden flex flex-col justify-between">
              <EnquiryForm buttonLabel="Request consultation call" />
            </div>

            {/* Places We Operate Card */}
            <div className="bg-[#FBF8F2] border-2 border-[#15120F]/15 rounded-3xl p-6 sm:p-8 shadow-[4px_4px_0px_0px_rgba(21,18,15,0.06)] flex flex-col justify-between h-full">
              <div>
                <Eyebrow as="span" className="block mb-1">Pan-India Presence</Eyebrow>
                  ...
                  {[
                    ...
                    <div key={loc.name} className="border border-[#15120F]/10 bg-[#FFFFFF] rounded-2xl p-3 flex flex-col justify-between hover:border-[#1D3F91] transition-colors">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="w-2 h-2 rounded-full bg-[#1D3F91]" />
                      </div>
