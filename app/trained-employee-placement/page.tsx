  ...
  return (
    <main className="min-h-screen min-h-dvh bg-[#FBF8F2] text-[#141110] font-sans selection:bg-[#1D3F91] selection:text-[#FFFFFF]">
      ...
      <section className="relative pt-28 pb-14 overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-[380px] h-[380px] bg-[#1D3F91]/10 rounded-full blur-3xl opacity-50 pointer-events-none" />
        <div className="absolute inset-0 bg-grid-bg opacity-15 pointer-events-none" />

        <div className="max-w-[1440px] mx-auto px-6 lg:px-10 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <Eyebrow prefixDot as="span" className="block mb-3">
      ...
      <section className="py-24 max-w-[1440px] mx-auto px-6 lg:px-10">
        ...
        <RevealGroup className="grid md:grid-cols-3 gap-8">
          {trainingModules.map((item) => (
            <div
              key={item.title}
              className="border border-[#141110]/10 bg-[#F4EFE5]/40 rounded-3xl p-8 hover:border-[#1D3F91]/30 transition-all flex flex-col justify-between"
            >
              <div>
      ...
      <section className="py-24 bg-[#101F45] text-[#FBF8F2] border-y-2 border-[#1D3F91]/40">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Eyebrow variant="on-dark" prefixDot as="span" className="block mb-2">
              ONBOARDING COMPARISON
            </Eyebrow>
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#FBF8F2]">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Traditional Hiring */}
            <div className="bg-[#101F45] border border-white/10 rounded-3xl p-8 space-y-6">
            ...
            <div className="bg-[#101F45] border-2 border-[#1D3F91] rounded-3xl p-8 space-y-6 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-[#1D3F91] text-[#FFFFFF] font-mono text-[9px] uppercase tracking-wider font-bold px-2 py-0.5 rounded">
                Talenty Model
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#1D3F91]/30 text-[#93B4F8] flex items-center justify-center">
              ...
              <ul className="space-y-3.5 text-xs text-[#F7F2E4]/90">
                {trained.map((t, idx) => (
                  <li key={idx} className="flex items-start gap-2.5 font-medium">
                    <Check className="w-4 h-4 text-[#93B4F8] mt-0.5 flex-shrink-0" />
                    <span>{t}</span>
                  </li>
                ))}
              </ul>
